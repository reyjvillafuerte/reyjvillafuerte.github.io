...
//	$('.rslides').responsiveSlides();
	...
	//	$('.header_to_bnr').css({'background-position' : '50% ' + (windowScroll * .07) +'%'});


	});


	//	$( ".page_nav ul li a" ).click(function( event )
		$(document).on('click', '.arrow_icon', function (event) {
	...
	anime.timeline({loop: false})
	  .add({
	    targets: '.banner_title_holder .letter',
	    scale: [0, 1],
	    duration: 3500,
	    elasticity: 200,
	    delay: function(el, i) {
